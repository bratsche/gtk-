...
typedef enum
{
  GTK_STYLE_CONTEXT_ROLE_INVALID,
  GTK_STYLE_CONTEXT_ROLE_BACKGROUND,
  GTK_STYLE_CONTEXT_ROLE_FOREGROUND,
  GTK_STYLE_CONTEXT_ROLE_SELECTION,
  GTK_STYLE_CONTEXT_ROLE_MOUSE_SELECTION,
  GTK_STYLE_CONTEXT_ROLE_FOCUS
} GtkStyleContextRole;

typedef enum
{
  GTK_WIDGET_STATE_PRELIGHT    = 1 << 0,
  GTK_WIDGET_STATE_ACTIVE      = 1 << 1,
  GTK_WIDGET_STATE_SELECTED    = 1 << 2,
  GTK_WIDGET_STATE_DEFAULT     = 1 << 3,
  GTK_WIDGET_STATE_INSENSITIVE = 1 << 4
} GtkWidgetState;

typedef enum
{
  GTK_PLACING_CONNECTS_UP    = 1 << 0,
  GTK_PLACING_CONNECTS_DOWN  = 1 << 1,
  GTK_PLACING_CONNECTS_LEFT  = 1 << 2,
  GTK_PLACING_CONNECTS_RIGHT = 1 << 3,
} GtkPlacingContext;
...
typedef enum
{
  ...
  GTK_TIMELINE_PROGRESS_SINUSOIDAL,
  GTK_TIMELINE_PROGRESS_EXPONENTIAL,
  GTK_TIMELINE_PROGRESS_EASE_IN_EASE_OUT
